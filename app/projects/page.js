...
function ProjectLogo({ logo }) {
  if (!logo) {
    ...
    return (
      <div className="relative h-full w-full min-h-[16rem] bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-950/20 dark:to-gray-900/20 flex items-center justify-center" />
    );
  }

  if (logo.type === 'library') {
    return (
      <div className={`relative h-full w-full min-h-[16rem] bg-gradient-to-br ${logo.color} flex items-center justify-center overflow-hidden group-hover:scale-105 transition-transform duration-300`}>
  ...
  if (logo.type === 'custom') {
    return (
      <div className={`relative h-full w-full min-h-[16rem] bg-gradient-to-br ${logo.color} flex items-center justify-center overflow-hidden group-hover:scale-105 transition-transform duration-300`}>
        <img src={logo.data} alt="Project logo" className="max-w-[120px] max-h-[120px] object-contain transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3" />
      </div>
    );
  }
  ...
  if (logo.type === 'image') {
    return (
      <div className="relative h-full w-full min-h-[16rem] overflow-hidden bg-black/5 dark:bg-white/5">
        <img
          src={logo.data}
          alt="Project banner"
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col md:flex-row">
                      ...
                      {/* Content Section */}
                      <div className="flex-1 p-8 transition-colors duration-300 group-hover:bg-black/[0.02] dark:group-hover:bg-white/[0.03]">
                        <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-4">
                          <h2 className="text-2xl font-semibold text-black dark:text-white mb-2 transition-transform duration-300 group-hover:scale-105">
                            {project.title}
                          </h2>
                          <div className="flex gap-3">
                            {project.demoUrl && (
                              <a
                                ...
                                className="text-sm text-black/60 dark:text-white/60 hover:text-black dark:hover:text-white transition-all duration-200 hover:translate-x-1 hover:scale-110"
                              >
                                Demo →
                              </a>
                            )}
